...
public class WordCount {
    public static void main(String[] args) throws Exception {
        ...
        //读取本地文件
//        final DataSource<String> stringDataSource = environment.readTextFile("D:\\tuling\\res\\flink\\wc.txt");
        final DataSource<String> stringDataSource = environment.readTextFile("/data/flink/wc.txt");
        //进行wordcount操作
